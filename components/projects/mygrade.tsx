    ...
    <>
        <div className="h-full flex flex-col items-center  bg-[#f5f0e8] p-2">
            ...
            <p className="text-lg retro-text mb-2">
                ...
                if I had any way of parsing through said segmentation to any meaningful degree.
                <br/>
                ... 
                <br/>
                Once I found a way to parse
            </p>
            <a className='mt-4  text-[#8b4513] text-xl font-bold underline font-retro' href='/reports/bachelor_report.pdf' target='_blank'>Github Repo</a>
        </div>
    </>
  )
}